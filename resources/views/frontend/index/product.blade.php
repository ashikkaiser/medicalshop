        ...
        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                    <div class="ps-product__variants">
                                        <div class="ps-product__gallery">
                                            <div class="ps-gallery__item active"><img src="{{ $product->photos }}"
                                                    alt="alt" /></div>
                                        </div>
                                        <div class="ps-product__thumbnail">
                                            <div class="ps-product__zoom"><img id="ps-product-zoom"
                                                    src="{{ $product->photos }}" alt="alt" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <form id="option-choice-form">
                                        ...
                                        <div class="ps-product__price">${{ $product->unit_price }} Per Pill</div>
                                        <div class="ps-product__variable">
                                            ...
                                            <div class="ps-product__type">
                                                ...
                                                @foreach (Dose($product) as $dose)
                                                    <span class="ps-product__attribute attribute-text" for="exampleCheck1"
                                                        data-value="{{ $dose }}">{{ $dose }}</span>
                                                @endforeach

                                            </div>
                                            <span>Package:</span>
                                            <select class="form-control variantSelect" name="variant" id="variant">

                                            </select>
                                        </div>
                                        <div class="ps-product__sale">
                                            <span class="price-sale">$8.90</span><span
                                                class="price discount-price">$9.90</span>
                                            <span class="ps-product__off">15% Off</span>
                                        </div>
                                        <div class="ps-product__avai alert__success">Availability: <span
                                                class="p-stok-total"></span>
                                        </div>
                                        ...
                                        <div class="ps-product__shopping">
                                            <div class="ps-product__quantity">
                                                ...
                                                <div class="def-number-input number-input aiz-plus-minus safari_only">
                                                    <button class="minus" type="button" data-type="minus"
                                                        data-field="quantity">
                                                        <i class="icon-minus"></i>
                                                    </button>
                                                    <input class="quantity" name="quantity" value="1" min="1" max="1000"
                                                        type="number">
                                                    <button class="plus" type="button" data-type="plus"
                                                        data-field="quantity">
                                                        <i class="icon-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="ps-product__addcart ps-button" onclick="addToCart()"><i
                                                    class="icon-cart"></i>Add to cart</div>
                                            {{-- <div class="ps-product__addcart ps-button"
                                                onclick="hellox()">
                                                <i class="icon-cart"></i>Add to cart
                                            </div> --}}
                                            {{-- <a class="ps-product__icon"
                                                href="wishlist.html"><i class="icon-heart"></i></a>
                                        ...
                                        <div class="ps-product__category">
                                            <ul>
                                                <li>Brand: <a href='shop-all-brands.html'
                                                        class='text-success'>FarmMatket</a>
                                                </li>
                                                <li>Vendor: <a href='shop-all-brands.html' class='text-success'>Local
                                                        Argus</a>
                                                </li>
                                                <li>Categories: <a href='shop-all-brands.html'
                                                        class='text-success'>Fresh</a>,
                                                    <a href='shop-all-brands.html' class='text-success'>Vegetales</a>, <a
                                                        href='shop-all-brands.html' class='text-success'>Olives & Selection
                                                        Platters</a>
                                                </li>
                                                <li>Tags: <a href='shop-all-brands.html' class='text-primary'>meat organic
                                                        food</a>, <a href='shop-all-brands.html'
                                                        class='text-success'>beet</a>,
                                                    <a href='shop-all-brands.html' class='text-success'>healthy</a>, <a
                                                        href='shop-all-brands.html' class='text-success'>foody</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="ps-product__footer"><a class="ps-product__shop"
                                                ...
                                                data-target="#popupAddToCart"><i class="icon-cart"></i>Add to cart</a></div>
                                    </form>
                                </div>
                            </div>
                        </div>
            ...
            <div class="product__content">
                <ul class="nav nav-pills" role="tablist" id="productTabDetail">
                    ...
                    <li class="nav-item"><a class="nav-link" id="nutrition-tab" data-toggle="tab" href="#nutrition-content"
                            role="tab" aria-controls="nutrition-content" aria-selected="false">Nutrition</a></li>
                    <li class="nav-item"><a class="nav-link" id="reviews-tab" data-toggle="tab" href="#reviews-content"
                            role="tab" aria-controls="reviews-content" aria-selected="false">Reviews(4)</a></li>
                    <li class="nav-item"><a class="nav-link" id="qa-tab" data-toggle="tab" href="#qa-content" role="tab"
                            aria-controls="qa-content" aria-selected="false">Q&A</a></li>
                    <li class="nav-item"><a class="nav-link" id="vendor-tab" data-toggle="tab" href="#vendor-content"
                            role="tab" aria-controls="vendor-content" aria-selected="false">Vendor Info</a></li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description-content" role="tabpanel"
                        aria-labelledby="description-tab">
                        <p class="block-content">Raised without antibiotics and full of flavor, this beef is the base of
                            big, juicy burgers, savory meat loaf and rich Bolognese sauce. You can enjoy this delicious
                            local ground beef for your meatloaf, burgers, meatballs, shepherd's pie, spicy taco meat and so
                            much more.</p>
                        <p class="block-content">As one of Farmart's premium beef suppliers, <b class='text-black'>Local
                                Angus</b> works with a coalition of small family farms throughout the Mid-Atlantic region
                            *who feed theri cattle a diet of primarily grass, supplemented by grain throughout the finishing
                            months. Every farm in this program is independently audited for animal welfare practices to
                            ensure the best standards of care.</p>
                        ...
                        <p class="block-content">Keep refrigerated 0-5<sup>o</sup>C. Consume within the use by date. Once
                            pack is opened use on the same day. Suitable for free zing on day of purchase. Use within one
                            month. Defrost fully before use. Do not re-freeze once defrosted.</p>
                        <div class="heading-2">Pan Fry</div>
                        <p class="block-content">Pour a little oil into a frying pan and cook for 4-6 minutes until browned.
                            If preferred, drain off excess fat. Add a good beef stock, seasonal vegetables and a sprinkling
                            of sea salt and freshly ground black pepper. Bring to the boil and reduce heat to simmer for 20
                            minutes until the meat is thoroughly cooked and your kitchen smells delicious. Wash hands,
                            knives and surfaxes thoroughly before and after preparing raw meat.</p>
                        <div class="heading-2">Return To Address</div>
                        <p class="block-content"><span class='text-success'>Daylesford near Kingham, Gloucestershire GL56
                                OYG</span></p>
                        <p class="block-content">We choose British breeds who thrive in their native landscape and encourage
                            healthy biodiversity on our farm. We avoid waste of any kind, so manure and kitchen waste
                            compost are returned to the soil as rich natural fertilisers. We have built our own abattoir to
                            ensure the highest animal welfare and reduced food miles, which results in better tasting meat,
                            and we spread our message far beyond the boundaries of our own fields.</p>
                        <p class="block-content">Each step of our journey is made with a conscience, and a love for food.
                        </p>
                    </div>
                    <div class="tab-pane fade" id="nutrition-content" role="tabpanel" aria-labelledby="nutrition-tab">
                        ...
                        <p class="block-content">Beef, Preservatives (Potassium Lactate, Sodium Acetates, Sodium Nitrite,
                            Potassium Nitrite), Salt, Sugar, Maize Starch, Spices, Caramelised Sugar Powder, Smoked Paprika,
                            Garlic Powder, Onion Powder, Rapeseed Oil, Thyme, Parsley, Prepared with 109g of Beef per 100g
                            of finished product.</p>
                        <div class="heading-2">Dietary Information </div>
                        <p class="block-content">May Contain Celery, May Contain Cereals Containing Gluten, May Contain
                            Eggs, May Contain Fish, May Contain Milk, May Contain Mustard, May Contain Soya.</p>
                        <table class="table">
                        ...
                        <p class="text-center pb-4"><i>* Based on a 2,000 calorie diet. Your daily values may be higher or
                                lower depending on your calorie needs:</i></p>
                    </div>
                        ...
                        <div class="ps-product--reviews">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-7">
                                    ...
                                    <p class="mb-0">Your email will not be published. Required fields are marked <span
                            ...
                            <div class="ps--comments">
                                ...
                                <ul class="comment__list">
                                    <li class="comment__item">
                                        <div class="item__avatar"><img src="img/blogs/comment_avatar1.png" alt="alt" />
                                        </div>
                                        <div class="item__content">
                                            <div class="item__name">Elyn Y.</div>
                                            <div class="item__date">- June 14, 2020</div>
                                            <div class="item__check"> <i class="icon-checkmark-circle"></i>Verified Purchase
                                            </div>
                                            ...
                                            <p class="item__des">Farmart is great. Farmart is the most valuable business
                                                resource we have EVER purchased. I have gotten at least 50 times the value
                                                from Farmart. I just can't get enough of Farmart. I want to get a T-Shirt
                                                with Farmart on it so I can show it off to everyone.</p>
                                        </div>
                                    </li>
                                    <li class="comment__item">
                                        <div class="item__avatar"><img src="img/blogs/comment_avatar2.png" alt="alt" />
                                        </div>
                                        <div class="item__content">
                                    ...
                                    <li class="comment__item">
                                        <div class="item__avatar"><img src="img/blogs/comment_no_avatar.png" alt="alt" />
                                        </div>
                                        <div class="item__content">
                    ...
                    <div class="tab-pane fade" id="vendor-content" role="tabpanel" aria-labelledby="vendor-tab">Vendor Info
                    </div>
                </div>
            </div>
            <div class="product__related" id="productTabDetailContent">
                <h3 class="product__name">Related Products</h3>
                <div class="owl-carousel" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0"
                    ...
                    <div class="ps-post--product">
                        <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail"
                                    src="img/products/01-Fresh/01_29a.jpg" alt="alt" /></a><a class="ps-product__expand"
                                href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i
                            ...
                            <div class="ps-product__content">
                                ...
                                <p class="ps-product-price-block"><span class="ps-product__sale">$15.90</span><span
                                        class="ps-product__price">$20.00</span><span class="ps-product__off">23% Off</span>
                                </p>
                            </div>
                            <div class="ps-product__footer">
                                ...
                                <button class="ps-product__addcart" data-toggle="modal" data-target="#popupAddToCart"><i
                    ...
                    <div class="ps-post--product">
                        <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail"
                                    src="img/products/01-Fresh/01_13a.jpg" alt="alt" /></a><a class="ps-product__expand"
                                href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i
                                    class="icon-expand"></i></a>
                            <div class="ps-product__content">
                                <p class="ps-product__type"><i class="icon-store"></i>Farmart</p>
                                <h5><a class="ps-product__name" href="product-default.html">Extreme Budweiser Light Can</a>
                                </h5>
                                ...
                                <p class="ps-product-price-block"><span class="ps-product__sale">$6.99</span><span
                                        class="ps-product__price">$12.00</span><span class="ps-product__off">45% Off</span>
                                </p>
                            </div>
                            <div class="ps-product__footer">
                                <div class="def-number-input number-input safari_only">
                    ...
                    <div class="ps-post--product">
                        <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail"
                                    src="img/products/01-Fresh/01_30a.jpg" alt="alt" /></a><a class="ps-product__expand"
                                href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i
                                    class="icon-expand"></i></a>
                            <div class="ps-product__content">
                                <p class="ps-product__type"><i class="icon-store"></i>Farmart</p>
                                ...
                                <p class="ps-product-price-block"><span class="ps-product__sale">$12.90</span><span
                                        class="ps-product__price">$20.99</span><span class="ps-product__off">25% Off</span>
                                </p>
                            </div>
                            <div class="ps-product__footer">
                                <div class="def-number-input number-input safari_only">
                    ...
                    <div class="ps-post--product">
                        <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail"
                                    src="img/products/01-Fresh/01_1a.jpg" alt="alt" /></a><a class="ps-product__expand"
                                href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i
                                    class="icon-expand"></i></a><span class="ps-badge ps-product__new">New </span>
                            <div class="ps-product__content">
                                <p class="ps-product__type"><i class="icon-store"></i>Farmart</p>
                                <h5><a class="ps-product__name" href="product-default.html">Morrisons The Best Beef
                                        Topside</a></h5>
                                ...
                                <p class="ps-product-price-block"><span class="ps-product__sale">$5.99</span><span
                                        class="ps-product__price">$8.99</span><span class="ps-product__off">30% Off</span>
                                </p>
                            </div>
                            <div class="ps-product__footer">
                                <div class="def-number-input number-input safari_only">
                    ...
                    <div class="ps-post--product">
                        <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail"
                                    src="img/products/01-Fresh/01_18a.jpg" alt="alt" /></a><a class="ps-product__expand"
                                href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i
                                    class="icon-expand"></i></a>
                            <div class="ps-product__content">
                    ...
                    <div class="ps-post--product">
                        <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail"
                                    src="img/products/06-SoftDrinks-TeaCoffee/06_11a.jpg" alt="alt" /></a><a
                                class="ps-product__expand" href="javascript:void(0);" data-toggle="modal"
...
@section('script')
    ...
    <script>
        function addToCart() {
            ...
            var variant = data.find(function(element) {
                return element.name == 'variant';
            });
            
            if(variant ==undefined){
                return alert('Please Select Dose First')
            }
            if(variant.value ==0){
    ...
    <script>
        $('.variantSelect').hide()
        $('.ps-product__avai').hide()
        $('.ps-product__attribute').on('click', function() {
            $('#doseID').val($(this).attr('data-value'))
            axios.post("{{ route('variantProduct') }}", {
                product_id: "{{ $product->id }}",
                value: $(this).attr('data-value')
            }).then(res => {
                $("#variant").html(null)
                $('.variantSelect').hide('slow')
                $("#variant").append('<option value="0"> Select Package</option>');

                $.each(res.data, function(key, value) {
                    $("#variant").append('<option value=' + value._id + '>' + value.variant +
                        '</option>');
                });
                $('.variantSelect').show('slow')
            })
        })
        $("#variant").on('change', function() {
            axios.post("{{ route('AjaxProduct') }}", {
                product_id: "{{ $product->id }}",
                value: $("#variant").val()
            }).then(res => {
                var pices = res.data.variant.split('-')[1].replace(/\D/g, "")
                $('.ps-product__avai').show('slow')

                $('.price-sale').text("$ " + res.data.price)
                $('.discount-price').text("$ " + pices)
                $('.p-stok-total').text(res.data.qty + " in stock")
            })
        })
